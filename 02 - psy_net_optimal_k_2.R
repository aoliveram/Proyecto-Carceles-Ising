...
results_grid_parallel_1 <- read.csv("psy_net_files/optimal_k_grid_parallel_1_1.csv")
results_grid_parallel_2 <- read.csv("psy_net_files/optimal_k_grid_parallel_1_2.csv")
results_grid_parallel_3 <- read.csv("psy_net_files/optimal_k_grid_parallel_1_3.csv")
results_grid_parallel_4 <- read.csv("psy_net_files/optimal_k_grid_parallel_1_4.csv")
results_grid_parallel_5 <- read.csv("psy_net_files/optimal_k_grid_parallel_1_5.csv")
results_grid_parallel_6 <- read.csv("psy_net_files/optimal_k_grid_parallel_1_6.csv")
