...
```{r ising, echo=FALSE, warning=FALSE, message=FALSE, include=TRUE}
...
png(paste0(aqui,"/pape/ising/redes_14.png"), width = 1800, height = 600)  # Tamaño ajustado para tres redes
...
x <- read.csv(paste0(aqui,"/pape/ising/nct_13_14_pvalues.csv"))
...
png(paste0(aqui,"/pape/ising/redes_14_diferencias.png"), width = 1800, height = 600)
...
# Graficar las redes adj1 y adj3
png(paste0(aqui,"/pape/ising/redes_14_diferencias_destacadas.png"), width = 1800, height = 600)
par(mfrow = c(1, 2), mar = c(2, 2, 2, 2))  # Dos paneles en una fila
